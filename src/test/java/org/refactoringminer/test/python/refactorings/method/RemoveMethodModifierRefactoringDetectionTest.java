...
public class RemoveMethodModifierRefactoringDetectionTest {

    @Test
    void detectsRemoveStaticModifier() throws Exception {
        ...
        assertRemoveMethodModifierDetected(beforeFiles, afterFiles,
                "compute", "static");
    }

    @Test
    void detectsRemoveAbstractModifier() throws Exception {
        String beforePythonCode = """
    ...
    @Test
    void detectsRemoveStaticModifier_WithComplexMethod() throws Exception {
        String beforePythonCode = """
            class DataProcessor:
                @staticmethod
    ...
    @Test
    void detectsRemoveAbstractModifier_WithNestedLoops() throws Exception {
        String beforePythonCode = """
            from abc import abstractmethod
    ...
    @Test
    void detectsRemoveStaticModifier_WithExceptionHandling() throws Exception {
        String beforePythonCode = """
            class FileHandler:
                @staticmethod
    ...
    @Test
    void detectsRemoveAbstractModifier_WithListComprehensions() throws Exception {
        String beforePythonCode = """
            from abc import abstractmethod
    ...
    @Test
    void detectsRemoveStaticModifier_WithInnerFunctions() throws Exception {
        String beforePythonCode = """
            class TaskManager:
                @staticmethod
    ...
    @Test
    void detectsRemoveAbstractModifier_WithWhileLoops() throws Exception {
        String beforePythonCode = """
            from abc import abstractmethod
    ...
    @Test
    void detectsRemoveStaticModifier_WithComplexConditionals() throws Exception {
        String beforePythonCode = """
    ...
    @Test
    void detectsRemoveAbstractModifier_ModuleLevelToClass() throws Exception {
        String beforePythonCode = """
            from abc import abstractmethod
    ...
    private void assertRemoveMethodModifierDetected(
        ...
        assertEquals(true, beforeHasModifier,
                "Before operation should have " + modifier + " modifier");
        assertEquals(false, afterHasModifier,
                "After operation should not have " + modifier + " modifier");

        // Check for the remove method modifier refactoring
        ...
        boolean removeModifierDetected = diff.getRefactorings().stream()
                .anyMatch(ref -> {
                    if (ref instanceof RemoveMethodModifierRefactoring removeModifierRef) {
                        return removeModifierRef.getOperationBefore().getName().equals(methodName) &&
                                removeModifierRef.getOperationAfter().getName().equals(methodName) &&
        ...
        assertTrue(removeModifierDetected,
                "Expected remove " + modifier + " modifier refactoring for operation " + methodName);
    }
