...
public class ReplaceAssertionRefactoring extends AssertionRefactoring implements MethodLevelRefactoring, LeafMappingProvider {
	private Set<AbstractCodeMapping> mappings;
	private AbstractCall newAssertionCall;
	private VariableDeclarationContainer operationBefore;
	private VariableDeclarationContainer operationAfter;
	private List<LeafMapping> subExpressionMappings;

	public ReplaceAssertionRefactoring(Set<AbstractCodeMapping> mappings, AbstractCall newAssertionCall,
			VariableDeclarationContainer operationBefore, VariableDeclarationContainer operationAfter) {
		this.mappings = mappings;
		this.newAssertionCall = newAssertionCall;
	...
	public List<CodeRange> rightSide() {
		...
		for(AbstractCodeMapping mapping : mappings) {
			...
			ranges.add(fragment.codeRange()
					.setDescription("replaced assertion code")
					.setCodeElement(fragment.getString()));
		}
		String elementType = operationAfter.getElementType();
		ranges.add(operationAfter.codeRange()
				.setDescription(elementType + " declaration with replaced assertion")
	...
	public RefactoringType getRefactoringType() {
		return RefactoringType.REPLACE_ASSERTION;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(newAssertionCall, mappings, operationAfter, operationBefore);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReplaceAssertionRefactoring other = (ReplaceAssertionRefactoring) obj;
		return Objects.equals(newAssertionCall, other.newAssertionCall)
