...
public class Constants {
    ...
    public static final String SIMPLE_NAME = "identifier";//"SimpleName";
    ...
    public static final String IMPORT_DECLARATION = "import_statement";//"ImportDeclaration";
    public static final String PRIMITIVE_TYPE = "PrimitiveType";
    public static final String TYPE_DECLARATION = "class_definition";//"TypeDeclaration";
    ...
    public static final String TYPE_DECLARATION_KIND = "class";//"TYPE_DECLARATION_KIND";
    ...
    public static final String BLOCK_COMMENT = "string";//"BlockComment";
